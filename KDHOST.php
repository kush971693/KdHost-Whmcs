...
use ModulesGarden\DomainsReseller\Registrar\KDHOST\Calls;
use ModulesGarden\DomainsReseller\Registrar\KDHOST\Core\Configuration;
use ModulesGarden\DomainsReseller\Registrar\KDHOST\Helpers\ResultsListFactory;

//Loader
include_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR . "Loader.php";
new \ModulesGarden\DomainsReseller\Registrar\KDHOST\Core\Loader(__DIR__);
 ...
 * @return array $return
 */
function KDHOST_getConfigArray()
{
    $configarray = [
        "FriendlyName" => [
            "Type"  => "System",
        ...
        "ApiEndpoint"  => [
            ...
            "Default"      => "https://my.kdhost.in/modules/addons/DomainsReseller/api/index.php"
        ],
    ];
 ...
 * @return array $return
 */
function KDHOST_RegisterDomain($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function KDHOST_TransferDomain($params)
{
    $postfields =
        [
            "domain"       => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_RenewDomain($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_GetNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function KDHOST_SaveNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_ReleaseDomain($params)
{
    $postfields =
        [
            "domain"      => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_GetEPPCode($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_GetContactDetails($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_SaveContactDetails($params)
{
    $postfields =
        [
            "domain"         => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_GetRegistrarLock($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_SaveRegistrarLock($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_SaveDNS($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_RegisterNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_ModifyNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_DeleteNameserver($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_RequestDelete($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function KDHOST_TransferSync($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function KDHOST_GetEmailForwarding($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function KDHOST_SaveEmailForwarding($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function KDHOST_IDProtectionToggle($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array
 */
function KDHOST_IDProtectToggle($params)
{
    return KDHOST_IDProtectionToggle($params);
}
 ...
 */
function KDHOST_CheckAvailability($params)
{
    $postfields =
        [
